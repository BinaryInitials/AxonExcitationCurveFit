...
public class Part2ParameterOptimizationDiameter {
	...
	public static final String FILE_NAME = "CubeFit.txt";
	public static final int CUBIC_POLYNOMIAL_DEGREE = 3;
	
	public static void main(String[] args) throws IOException {
		Date tic = new Date();
		System.out.println("Calculating cube fit for Alpha, Beta, Mu, and Nu...");
		...
		List<String[]> input = Methods.readFile(Part1SpliceData.FILE_NAME, true);
		...
		for(Parameter parameter : Parameter.values()){
			...
			for(OffSet offSet : OffSet.values()){
				...
				Methods.writeToFile(parameter.toString() + "_" + FILE_NAME, output);
			}
		}
